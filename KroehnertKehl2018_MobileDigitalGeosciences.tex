...
\textcolor{blue}{Chris: correction-read until here. The orientation part really reads quite 'bang-on' photogrammetric and I really suggest putting this - toegether with the battery part - into an actual PHOR paper and give a VERY CONDENSED version of that in CAGEO. I fear (as I do with the 'graphics' technology section too) that we may loose the geoscience audience, because they may ask themselves 'how does this affect me' -- and it's also not that traditional of a writing for a CS audience.}
