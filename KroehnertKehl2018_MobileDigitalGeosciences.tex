...
In comparison to mesh-based rendering, simple point projection seems to be a nice alternative, saving computational resources and efforts for post-processing regarding outlier removal.% due to falsely surface reconstruction like blobs. \textit{Chris: do not know what you mean by that. hence cut.}
...
% This needs to be reformulated - somehow ... still uncertain 'how'
